...
run_analysis.R
--------------------------------
It downloads the UCI HAR Dataset data set and puts the zip file working directrory manually. After it is downloaded, it unzips the file into the UCI HAR Dataset folder.
